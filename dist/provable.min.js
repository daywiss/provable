...
function Engine(e,t){function n(e){return defaults({},e,{id:utils.seed(),index:0,count:1,seed:utils.seed(),publicSeed:null,maxHex:8})}function u(e){t(e)}function i(){return utils.toInt(i.next(s.publicSeed),s.maxHex)}var s={},r=null;return i.state=function(){return s},i.hashes=function(){return r},i.last=function(e){return i.peek(s.index-1,e)},i.peek=function(e,t){return 0!==e&&null==e&&(e=s.index),t=t||s.publicSeed,utils.rehash(crypto,r[e],t)},i.next=function(e){var t=i.peek(null,e);return assert(t,"end of hash series"),s.index++,u(s),t},s=n(e),s.maxInt=Math.pow(2,4*s.maxHex),assert(s.seed,"requires seed value"),isFunction(t)||(t=function(){}),r=utils.generate(crypto,s.count,s.seed),u(s),i}var crypto=require("crypto"),assert=require("assert"),defaults=require("lodash/defaults"),isFunction=require("lodash/isFunction"),utils=require("./utils");Engine.generate=utils.generate,Engine.createSeed=utils.createSeed,Engine.rehash=utils.rehash,Engine.sha256=utils.sha256,Engine.toInt=utils.toInt,Engine.toFloat=utils.toFloat,Engine.toBool=utils.toBool,module.exports=Engine;

},{"./utils":211,"assert":16,"crypto":57,"lodash/defaults":142,"lodash/isFunction":149}],211:[function(require,module,exports){
var assert=require("assert");exports.createSeed=function(r){return assert(r,"requires rand"),r.uuid4()},exports.seed=function(r){var e="";r=r||24;for(var t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghipqrstuvwxyz0123456789",s=0;s<r;s++)e+=t.charAt(Math.floor(Math.random()*t.length));return e},exports.sha256=function(r,e){assert(r,"requires crypto");try{return r.createHash("sha256").update(e).digest("hex")}catch(t){return r.SHA256(e).toString()}},exports.rehash=function(r,e,t){if(assert(r,"requires crypto"),assert(e,"requires hash"),null==t)return e;try{return r.createHmac("sha256",e).update(t).digest("hex")}catch(s){return r.algo.HMAC.create(r.algo.SHA256,e).finalize(t).toString()}},exports.toInt=function(r,e){return assert(r,"requires hash"),e=e||8,assert(r.length>=e,"hash is not long enough"),parseInt(r.slice(-e),16)},exports.toFloat=function(r,e,t,s){return assert(r,"requires hash"),null==e&&(e=0),null==t&&(t=1),e+(t-e)*(toInt(r)/(s?maxInt+1:maxInt))},exports.toBool=function(r,e){return null==e&&(e=.5),toFloat(r)<e},exports.generate=function(r,e,t){assert(t,"requires seed value"),e=e||1;for(var s=Array(e),a=e-1;a>=0;a--)t=exports.sha256(r,t),s[a]=t;return s};
