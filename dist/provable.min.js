...
function Engine(e,n){function t(e){return defaults({},e,{id:utils.createSeed(),index:0,count:1,seed:utils.createSeed(),publicSeed:null,maxHex:8})}function u(e){n(e)}function i(){return utils.toInt(i.next(r.publicSeed),r.maxHex)}var r={},s=null;return i.state=function(){return r},i.hashes=function(){return s},i.last=function(e){return i.peek(r.index-1,e)},i.peek=function(e,n){return 0!==e&&null==e&&(e=r.index),n=n||r.publicSeed,utils.rehash(crypto,s[e],n)},i.next=function(e){var n=i.peek(null,e);return assert(n,"end of hash series"),r.index++,u(r),n},r=t(e),r.maxInt=Math.pow(2,4*r.maxHex),assert(r.seed,"requires seed value"),isFunction(n)||(n=function(){}),s=utils.generate(crypto,r.count,r.seed),u(r),i}var crypto=require("crypto"),assert=require("assert"),defaults=require("lodash/defaults"),isFunction=require("lodash/isFunction"),utils=require("./utils");Engine.generate=utils.generate.bind(null,crypto),Engine.createSeed=utils.createSeed.bind(null,crypto),Engine.rehash=utils.rehash.bind(null,crypto),Engine.sha256=utils.sha256.bind(null,crypto),Engine.toInt=utils.toInt,Engine.toFloat=utils.toFloat,Engine.toBool=utils.toBool,module.exports=Engine;

},{"./utils":211,"assert":16,"crypto":57,"lodash/defaults":142,"lodash/isFunction":149}],211:[function(require,module,exports){
var assert=require("assert");exports.createSeed=function(r,t){var e="";r=r||32,t=t||"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghipqrstuvwxyz0123456789";for(var s=0;s<r;s++)e+=t.charAt(Math.floor(Math.random()*t.length));return e},exports.sha256=function(r,t){assert(r,"requires crypto");try{return r.createHash("sha256").update(t).digest("hex")}catch(e){return r.SHA256(t).toString()}},exports.rehash=function(r,t,e){if(assert(r,"requires crypto"),assert(t,"requires hash"),null==e)return t;try{return r.createHmac("sha256",t).update(e).digest("hex")}catch(s){return r.algo.HMAC.create(r.algo.SHA256,t).finalize(e).toString()}},exports.toInt=function(r,t){return assert(r,"requires hash"),t=t||8,assert(r.length>=t,"hash is not long enough"),parseInt(r.slice(-t),16)},exports.toFloat=function(r,t,e,s){return assert(r,"requires hash"),null==t&&(t=0),null==e&&(e=1),t+(e-t)*(toInt(r)/(s?maxInt+1:maxInt))},exports.toBool=function(r,t){return null==t&&(t=.5),toFloat(r,0,1,!0)<t},exports.generate=function(r,t,e){assert(e,"requires seed value"),t=t||1;for(var s=Array(t),a=t-1;a>=0;a--)e=exports.sha256(r,e),s[a]=e;return s};
