...
var crypto=require("crypto"),assert=require("assert"),defaults=require("lodash/defaults"),isFunction=require("lodash/isFunction"),utils=require("./utils");function Engine(e,n){var t={},u=null;function i(e){n(e)}function r(){return utils.toInt(r.next(t.publicSeed),t.maxHex)}return r.state=function(){return t},r.hashes=function(e,n,i,r){e=e||0,n=i?n||t.count+1:n||t.count;var s=u;return i&&(s=u.concat([t.seed])),s=s.slice(e,n),r?s.reverse():s},r.last=function(e){return r.peek(t.index-1,e)},r.peek=function(e,n){return 0!==e&&null==e&&(e=t.index),n=n||t.publicSeed,utils.rehash(crypto,u[e],n)},r.next=function(e){var n=r.peek(null,e);return assert(n,"end of hash series"),t.index++,i(t),n},(t=function(e){return defaults({},e,{id:utils.createSeed(),index:0,count:1,seed:utils.createSeed(),publicSeed:null,maxHex:8})}(e)).maxInt=Math.pow(2,4*t.maxHex),assert(t.seed,"requires seed value"),isFunction(n)||(n=function(){}),u=utils.generate(crypto,t.count,t.seed),i(t),r}Engine.generate=utils.generate.bind(null,crypto),Engine.createSeed=utils.createSeed.bind(null,crypto),Engine.rehash=utils.rehash.bind(null,crypto),Engine.sha256=utils.sha256.bind(null,crypto),Engine.toInt=utils.toInt,Engine.toFloat=utils.toFloat,Engine.toBool=utils.toBool,module.exports=Engine;

},{"./utils":207,"assert":16,"crypto":58,"lodash/defaults":137,"lodash/isFunction":144}],207:[function(require,module,exports){
var assert=require("assert");exports.createSeed=function(t,e){var r="";t=t||32,e=e||"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghipqrstuvwxyz0123456789";for(var a=0;a<t;a++)r+=e.charAt(Math.floor(Math.random()*e.length));return r},exports.sha256=function(t,e){assert(t,"requires crypto");try{return t.createHash("sha256").update(e).digest("hex")}catch(r){return t.SHA256(e).toString()}},exports.rehash=function(t,e,r){if(assert(t,"requires crypto"),assert(e,"requires hash"),null==r)return e;try{return t.createHmac("sha256",e).update(r).digest("hex")}catch(a){return t.algo.HMAC.create(t.algo.SHA256,e).finalize(r).toString()}};var defaultHex=8,defaultMaxInt=Math.pow(2,32);function calcMaxInt(t){return(t=t||defaultHex)==defaultHex?defaultMaxInt:Math.pow(2,4*t)}exports.toInt=function(t,e,r){return assert(t,"requires hash"),e=e||defaultHex,assert(t.length>=e,"hash is not long enough"),r?parseInt(t.slice(0,e),16):parseInt(t.slice(-e),16)},exports.toFloat=function(t,e,r,a,s,n){assert(t,"requires hash"),null==e&&(e=0),null==r&&(r=1);var o=calcMaxInt(s);return e+(r-e)*(exports.toInt(t,s,n)/(a?o-1:o))},exports.toBool=function(t,e,r,a){return null==e&&(e=.5),exports.toFloat(t,0,1,!1,r,a)<e},exports.generate=function(t,e,r){assert(r,"requires seed value"),e=e||1;for(var a=Array(e),s=e-1;s>=0;s--)r=exports.sha256(t,r),a[s]=r;return a};
